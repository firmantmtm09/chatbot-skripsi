...
with col_portal_kiri:
    ...
    with selected_tab[1]:
        ...
        if sub_menu_profil == "Tugas dan Fungsi":
            ...
            * Pelaksanaan tugas dan fungsi kedinasan lain yang diberikan oleh Gubernur dan/atau Sekretaris Daerah.
            ...
            - **Kepala Dinas:** Drs. Denny Wahyu Haryanto, M.SI.
            - **Sekretaris Dinas Kependudukan dan Pencatatan Sipil:** Muhammad Nurrahman, S.Kom, MM.
            - **Kepala Bidang Pelayanan Pendaftaran Penduduk:** Shanti, S.Sos, MA.
            - **Kepala Bidang Pencatatan Sipil:** Witri Yeni, S.Sos, M.Si.
            - **Kepala Bidang Data dan Informasi:** Firman, ST.
            - **Kepala Bidang Pembinaan, Pengawasan, dan Pengendalian Administrasi Kependudukan:** Sudirman, SH.
            - **Kepala Unit Pelayanan Administrasi Kependudukan:** Desmond, S.Si, MM.
            - **Kepala Unit Pengelola Teknologi Informasi Kependudukan:** Hari Wibowo, MAP.
            """)
    ...
    with selected_tab[3]:
        ...
        with st.expander("📄 UU Nomor 24 Tahun 2013 tentang Administrasi Kependudukan"):
            st.write("""
            Undang-Undang Nomor 24 Tahun 2013 adalah perubahan atas UU No. 23 Tahun 2006 tentang Administrasi Kependudukan. Undang-undang yang disahkan pada 24 Desember 2013 ini mengubah masa berlaku KTP elektronik menjadi seumur hidup dan menegaskan bahwa seluruh pengurusan dokumen kependudukan di Indonesia tidak dipungut biaya alias gratis.
            """)
    ...
    if prompt := st.chat_input("Tanya syarat KK, KTP, atau Akta...", key="chatbot_input_unique"):
        ...
        with chat_container:
            with st.spinner("Mencari informasi..."):
                try:
                    response = requests.post(BACKEND_API_URL, json={"message": prompt}, timeout=300)
